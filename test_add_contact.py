...
class (unittest.TestCase):
    ...
    def test_(self):
        ...
        wd.find_element_by_name("middlename").send_keys("QA")
        ...
        wd.find_element_by_name("home").send_keys("3434")
        ...
        wd.find_element_by_name("fax").send_keys("3434")
        wd.find_element_by_name("email").click()
        wd.find_element_by_name("email").clear()
        wd.find_element_by_name("email").send_keys("example@ex.com")
