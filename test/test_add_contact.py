...
def test_add_contact(app):
    app.open_home_page()
    app.contact.add_new_contact(Contact(firstname="Name", middlename="QA", lastname="Lastname", nick="Nick", title="Title", company="OOO", home="3434", mobile="3434", work="3434", fax="3434",
